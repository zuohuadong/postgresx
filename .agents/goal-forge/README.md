...
npx tsx src/index.ts init --goal "<design goal>" --config "/Volumes/Data/workspace/pgredis/.agents/goal-forge/goal-forge.config.json" --out "/Volumes/Data/workspace/pgredis/.agents/goal-forge/runs/<run-id>"
```
...
```bash
cd "/Volumes/Data/workspace/goal-forge"
npx tsx src/index.ts run "/Volumes/Data/workspace/pgredis/.agents/goal-forge/runs/<run-id>" --rounds 1 --adapter local
npx tsx src/index.ts validate "/Volumes/Data/workspace/pgredis/.agents/goal-forge/runs/<run-id>" --strict
```
...
```bash
cd "/Volumes/Data/workspace/goal-forge"
npx tsx src/index.ts run "/Volumes/Data/workspace/pgredis/.agents/goal-forge/runs/<run-id>" --rounds 1 --adapter codex --repo "/Volumes/Data/workspace/pgredis" --model gpt-5.3-codex
```
